import 'package:astarte/pages/signupPages/aboutShop.dart';
...
void main(){
  runApp(FashionDesignerSignUp());
}

class FashionDesignerSignUp extends StatefulWidget {
  @override
  _FashionDesignerSignUpState createState() => _FashionDesignerSignUpState();
}

class _FashionDesignerSignUpState extends State<FashionDesignerSignUp> {
  ...
  void processForm(){
    if(_formKey.currentState.validate()) {
      var customerData = {
        ...
        'userType': 'fashionDesigner',
        'premium_expiration':'000-00-00',
        'status':'active'
      };
      Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: AboutShop(userInfo:customerData)));
    }
  }
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                            ...
                            child: Text("Exhibit your skills to millions of customers who need your service",style: TextStyle(fontFamily: "Lato_Regular",fontSize: 15),textAlign: TextAlign.center,))
                      ],
                    ),
                  ),
                  Form(
